...
Controlled GROMACS output checks command arguments, frame conversion, input preservation, and XVG mapping. It does not provide an independent production-trajectory comparison.
