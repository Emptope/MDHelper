...
class PlotControls(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self.series = QTableWidget(0, 6)
        self.series.setHorizontalHeaderLabels(
            ("Show", "Analysis", "Legend", "Color", "Selection", "Plot")
        )
        self.series.horizontalHeader().setStretchLastSection(True)
        self.series.setSelectionBehavior(QTableWidget.SelectionBehavior.SelectRows)
        self.series.setSelectionMode(QAbstractItemView.SelectionMode.ExtendedSelection)
        self.series.setMinimumHeight(100)
        self.series.setMaximumHeight(180)
